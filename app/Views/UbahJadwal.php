...
<section class="schedule-section">
    <div class="container">
        ...
        <div class="text-center mb-5">
            ...
            <p class="schedule-subheading mt-3">Masukkan kode booking yang Anda terima untuk mengubah jadwal konsultasi
            </p>
        </div>
        ...
        <div class="booking-card mx-auto" id="bookingLookup">
            ...
            <p class="booking-card__desc">Kode booking terdapat pada email konfirmasi atau SMS yang Anda terima saat
                melakukan pemesanan jadwal.</p>
            ...
            <form id="formBookingCode" class="booking-form" onsubmit="return handleLookup(event)">
                <div class="booking-input-group">
                    ...
                    <input type="text" id="inputBookingCode" class="booking-input" placeholder="Contoh: BK-2024-XXXX"
        ...
        <div class="booking-success-card mx-auto d-none" id="bookingSuccess">
            ...
            <p class="booking-card__desc">Jadwal booking Anda telah berhasil diperbarui. Detail perubahan telah dikirim
                ke email Anda.</p>
